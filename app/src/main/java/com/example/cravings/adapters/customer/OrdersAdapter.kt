...
class OrdersAdapter(private val orders: List<Order>) :
    ...
    private fun confirmDelivery(order: Order, context: Context, wasDelivered: Boolean) {
    ...
    private fun creditDeliveryDriver(driverId: String, deliveryFee: Double, context: Context) {
